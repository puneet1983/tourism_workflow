...
user_id = "puneet83"
Xtrain_path = f"hf://datasets/{user_id}/tourism_product/Xtrain.csv"
Xtest_path = f"hf://datasets/{user_id}/tourism_product/Xtest.csv"
ytrain_path = f"hf://datasets/{user_id}/tourism_product/ytrain.csv"
ytest_path = f"hf://datasets/{user_id}/tourism_product/ytest.csv"
...
with open("tourism_project/model_building/best_params.json", "r") as f:
...
with mlflow.start_run():
    ...
    repo_id = f"{user_id}/tourism-churn-model"
    repo_type = "model"
